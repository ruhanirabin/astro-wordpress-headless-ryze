...
- improve: Make archive year navigation more compact on mobile.
...
- fix: Remove duplicate pages from the sitemap.
- improve: Improve sitemap coverage for public pages.
